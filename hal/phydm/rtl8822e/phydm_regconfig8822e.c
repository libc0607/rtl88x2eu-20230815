...
void odm_config_rf_reg_8822e(struct dm_struct *dm, u32 addr, u32 data,
...
void odm_config_rf_radio_a_8822e(struct dm_struct *dm, u32 addr, u32 data)
{
	u32 content = 0x1000; /* RF_Content: radioa_txt */
	u32 maskfor_phy_set = (u32)(content & 0xE000);

	odm_config_rf_reg_8822e(dm, addr, data, RF_PATH_A, addr |
				maskfor_phy_set);
...
void odm_config_rf_radio_b_8822e(struct dm_struct *dm, u32 addr, u32 data)
{
	u32 content = 0x1001; /* RF_Content: radiob_txt */
	u32 maskfor_phy_set = (u32)(content & 0xE000);

	odm_config_rf_reg_8822e(dm, addr, data, RF_PATH_B, addr |
				maskfor_phy_set);
...
void phydm_agc_lower_bound_8822e(struct dm_struct *dm, u32 addr, u32 data)
{
	...
	if (!dm->l_bnd_detect[tab] && rxbb_gain == RXBB_MAX_GAIN_8822E) {
		dm->ofdm_rxagc_l_bnd[tab] = mp_gain;
		dm->l_bnd_detect[tab] = true;
	}
}

void phydm_agc_store_8822e(struct dm_struct *dm, u32 addr, u32 data)
{
...
void odm_config_bb_agc_8822e(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
	phydm_agc_lower_bound_8822e(dm, addr, data);
	phydm_agc_store_8822e(dm, addr, data);
...
void odm_config_bb_phy_reg_pg_8822e(struct dm_struct *dm, u32 band, u32 rf_path,
...
void odm_config_bb_phy_8822e(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
	if (dm->fw_offload_ability & PHYDM_PHY_PARAM_OFFLOAD) {
		u32 delay_time = 0;
...
void odm_config_bb_txpwr_lmt_8822e_ex(struct dm_struct *dm, u8 regulation,
...
void odm_config_bb_txpwr_lmt_8822e(struct dm_struct *dm, u8 *regulation,
				   u8 *band, u8 *bandwidth, u8 *rate_section,
